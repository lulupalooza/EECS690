...
$C$DW$1	.dwtag  DW_TAG_variable, DW_AT_name("g_pui8Crc8CCITT")
...
$C$DW$2	.dwtag  DW_TAG_variable, DW_AT_name("g_pui16Crc16")
...
$C$DW$3	.dwtag  DW_TAG_variable, DW_AT_name("g_pui32Crc32")
...
$C$DW$4	.dwtag  DW_TAG_subprogram, DW_AT_name("Crc8CCITT")
...
;* --------------------------------------------------------------------------*
	...
	.dwcfi	cfa_offset, 16
$C$DW$8	.dwtag  DW_TAG_variable, DW_AT_name("ui8Crc")
	.dwattr $C$DW$8, DW_AT_TI_symbol_name("ui8Crc")
	.dwattr $C$DW$8, DW_AT_type(*$C$DW$T$27)
	.dwattr $C$DW$8, DW_AT_location[DW_OP_breg13 0]
$C$DW$9	.dwtag  DW_TAG_variable, DW_AT_name("pui8Data")
	.dwattr $C$DW$9, DW_AT_TI_symbol_name("pui8Data")
	.dwattr $C$DW$9, DW_AT_type(*$C$DW$T$29)
	.dwattr $C$DW$9, DW_AT_location[DW_OP_breg13 4]
$C$DW$10	.dwtag  DW_TAG_variable, DW_AT_name("ui32Count")
	.dwattr $C$DW$10, DW_AT_TI_symbol_name("ui32Count")
	.dwattr $C$DW$10, DW_AT_type(*$C$DW$T$19)
	.dwattr $C$DW$10, DW_AT_location[DW_OP_breg13 8]
$C$DW$11	.dwtag  DW_TAG_variable, DW_AT_name("ui32Temp")
	.dwattr $C$DW$11, DW_AT_TI_symbol_name("ui32Temp")
	.dwattr $C$DW$11, DW_AT_type(*$C$DW$T$19)
	.dwattr $C$DW$11, DW_AT_location[DW_OP_breg13 12]
        STR       A3, [SP, #8]          ; [DPU_3_PIPE] |267| 
        STR       A2, [SP, #4]          ; [DPU_3_PIPE] |267| 
        STRB      A1, [SP, #0]          ; [DPU_3_PIPE] |267| 
	.dwpsn	file "../driverlib/sw_crc.c",line 274,column 5,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |274| 
        LSRS      A1, A1, #1            ; [DPU_3_PIPE] |274| 
        BCC       ||$C$L1||             ; [DPU_3_PIPE] |274| 
        ; BRANCHCC OCCURS {||$C$L1||}    ; [] |274| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../driverlib/sw_crc.c",line 279,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |279| 
        LDRB      A3, [SP, #0]          ; [DPU_3_PIPE] |279| 
        LDR       A2, $C$CON1           ; [DPU_3_PIPE] |279| 
        LDRB      A1, [A1, #0]          ; [DPU_3_PIPE] |279| 
        EORS      A1, A1, A3            ; [DPU_3_PIPE] |279| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |279| 
        LDRB      A1, [A2, +A1]         ; [DPU_3_PIPE] |279| 
        STRB      A1, [SP, #0]          ; [DPU_3_PIPE] |279| 
	.dwpsn	file "../driverlib/sw_crc.c",line 284,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |284| 
        ADDS      A1, A1, #1            ; [DPU_3_PIPE] |284| 
        STR       A1, [SP, #4]          ; [DPU_3_PIPE] |284| 
	.dwpsn	file "../driverlib/sw_crc.c",line 285,column 9,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |285| 
        SUBS      A1, A1, #1            ; [DPU_3_PIPE] |285| 
        STR       A1, [SP, #8]          ; [DPU_3_PIPE] |285| 
;* --------------------------------------------------------------------------*
||$C$L1||:    
	.dwpsn	file "../driverlib/sw_crc.c",line 292,column 5,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |292| 
        LSRS      A1, A1, #2            ; [DPU_3_PIPE] |292| 
        BCC       ||$C$L2||             ; [DPU_3_PIPE] |292| 
        ; BRANCHCC OCCURS {||$C$L2||}    ; [] |292| 
;* --------------------------------------------------------------------------*
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |292| 
        CMP       A1, #1                ; [DPU_3_PIPE] |292| 
        BLS       ||$C$L2||             ; [DPU_3_PIPE] |292| 
        ; BRANCHCC OCCURS {||$C$L2||}    ; [] |292| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../driverlib/sw_crc.c",line 297,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |297| 
        LDRH      A1, [A1, #0]          ; [DPU_3_PIPE] |297| 
        STR       A1, [SP, #12]         ; [DPU_3_PIPE] |297| 
	.dwpsn	file "../driverlib/sw_crc.c",line 302,column 9,is_stmt,isa 1
        LDRB      A3, [SP, #0]          ; [DPU_3_PIPE] |302| 
        LDR       A2, $C$CON1           ; [DPU_3_PIPE] |302| 
        LDR       A1, [SP, #12]         ; [DPU_3_PIPE] |302| 
        EORS      A1, A1, A3            ; [DPU_3_PIPE] |302| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |302| 
        LDRB      A1, [A2, +A1]         ; [DPU_3_PIPE] |302| 
        STRB      A1, [SP, #0]          ; [DPU_3_PIPE] |302| 
	.dwpsn	file "../driverlib/sw_crc.c",line 303,column 9,is_stmt,isa 1
        LDR       A3, [SP, #12]         ; [DPU_3_PIPE] |303| 
        LDRB      A1, [SP, #0]          ; [DPU_3_PIPE] |303| 
        LDR       A2, $C$CON1           ; [DPU_3_PIPE] |303| 
        EOR       A1, A1, A3, LSR #8    ; [DPU_3_PIPE] |303| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |303| 
        LDRB      A1, [A2, +A1]         ; [DPU_3_PIPE] |303| 
        STRB      A1, [SP, #0]          ; [DPU_3_PIPE] |303| 
	.dwpsn	file "../driverlib/sw_crc.c",line 308,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |308| 
        ADDS      A1, A1, #2            ; [DPU_3_PIPE] |308| 
        STR       A1, [SP, #4]          ; [DPU_3_PIPE] |308| 
	.dwpsn	file "../driverlib/sw_crc.c",line 309,column 9,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |309| 
        SUBS      A1, A1, #2            ; [DPU_3_PIPE] |309| 
        STR       A1, [SP, #8]          ; [DPU_3_PIPE] |309| 
;* --------------------------------------------------------------------------*
||$C$L2||:    
	.dwpsn	file "../driverlib/sw_crc.c",line 316,column 11,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |316| 
        CMP       A1, #3                ; [DPU_3_PIPE] |316| 
        BLS       ||$C$L4||             ; [DPU_3_PIPE] |316| 
...
||$C$L3||:    
	...
	.dwpsn	file "../driverlib/sw_crc.c",line 326,column 9,is_stmt,isa 1
        LDRB      A3, [SP, #0]          ; [DPU_3_PIPE] |326| 
        LDR       A2, $C$CON1           ; [DPU_3_PIPE] |326| 
        LDR       A1, [SP, #12]         ; [DPU_3_PIPE] |326| 
        EORS      A1, A1, A3            ; [DPU_3_PIPE] |326| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |326| 
        LDRB      A1, [A2, +A1]         ; [DPU_3_PIPE] |326| 
        STRB      A1, [SP, #0]          ; [DPU_3_PIPE] |326| 
	.dwpsn	file "../driverlib/sw_crc.c",line 327,column 9,is_stmt,isa 1
        LDR       A3, [SP, #12]         ; [DPU_3_PIPE] |327| 
        LDRB      A1, [SP, #0]          ; [DPU_3_PIPE] |327| 
        LDR       A2, $C$CON1           ; [DPU_3_PIPE] |327| 
        EOR       A1, A1, A3, LSR #8    ; [DPU_3_PIPE] |327| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |327| 
        LDRB      A1, [A2, +A1]         ; [DPU_3_PIPE] |327| 
        STRB      A1, [SP, #0]          ; [DPU_3_PIPE] |327| 
	.dwpsn	file "../driverlib/sw_crc.c",line 328,column 9,is_stmt,isa 1
        LDR       A3, [SP, #12]         ; [DPU_3_PIPE] |328| 
        LDR       A2, $C$CON1           ; [DPU_3_PIPE] |328| 
        LDRB      A1, [SP, #0]          ; [DPU_3_PIPE] |328| 
        EOR       A1, A1, A3, LSR #16   ; [DPU_3_PIPE] |328| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |328| 
        LDRB      A1, [A2, +A1]         ; [DPU_3_PIPE] |328| 
        STRB      A1, [SP, #0]          ; [DPU_3_PIPE] |328| 
	.dwpsn	file "../driverlib/sw_crc.c",line 329,column 9,is_stmt,isa 1
        LDR       A3, [SP, #12]         ; [DPU_3_PIPE] |329| 
        LDR       A2, $C$CON1           ; [DPU_3_PIPE] |329| 
        LDRB      A1, [SP, #0]          ; [DPU_3_PIPE] |329| 
        EOR       A1, A1, A3, LSR #24   ; [DPU_3_PIPE] |329| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |329| 
        LDRB      A1, [A2, +A1]         ; [DPU_3_PIPE] |329| 
        STRB      A1, [SP, #0]          ; [DPU_3_PIPE] |329| 
	.dwpsn	file "../driverlib/sw_crc.c",line 334,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |334| 
        ADDS      A1, A1, #4            ; [DPU_3_PIPE] |334| 
        STR       A1, [SP, #4]          ; [DPU_3_PIPE] |334| 
	.dwpsn	file "../driverlib/sw_crc.c",line 335,column 9,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |335| 
        SUBS      A1, A1, #4            ; [DPU_3_PIPE] |335| 
        STR       A1, [SP, #8]          ; [DPU_3_PIPE] |335| 
	.dwpsn	file "../driverlib/sw_crc.c",line 316,column 11,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |316| 
        CMP       A1, #3                ; [DPU_3_PIPE] |316| 
        BHI       ||$C$L3||             ; [DPU_3_PIPE] |316| 
        ; BRANCHCC OCCURS {||$C$L3||}    ; [] |316| 
;* --------------------------------------------------------------------------*
||$C$L4||:    
	.dwpsn	file "../driverlib/sw_crc.c",line 342,column 5,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |342| 
        CMP       A1, #1                ; [DPU_3_PIPE] |342| 
        BLS       ||$C$L5||             ; [DPU_3_PIPE] |342| 
        ; BRANCHCC OCCURS {||$C$L5||}    ; [] |342| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../driverlib/sw_crc.c",line 347,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |347| 
        LDRH      A1, [A1, #0]          ; [DPU_3_PIPE] |347| 
        STR       A1, [SP, #12]         ; [DPU_3_PIPE] |347| 
	.dwpsn	file "../driverlib/sw_crc.c",line 352,column 9,is_stmt,isa 1
        LDRB      A3, [SP, #0]          ; [DPU_3_PIPE] |352| 
        LDR       A2, $C$CON1           ; [DPU_3_PIPE] |352| 
        LDR       A1, [SP, #12]         ; [DPU_3_PIPE] |352| 
        EORS      A1, A1, A3            ; [DPU_3_PIPE] |352| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |352| 
        LDRB      A1, [A2, +A1]         ; [DPU_3_PIPE] |352| 
        STRB      A1, [SP, #0]          ; [DPU_3_PIPE] |352| 
	.dwpsn	file "../driverlib/sw_crc.c",line 353,column 9,is_stmt,isa 1
        LDR       A3, [SP, #12]         ; [DPU_3_PIPE] |353| 
        LDRB      A1, [SP, #0]          ; [DPU_3_PIPE] |353| 
        LDR       A2, $C$CON1           ; [DPU_3_PIPE] |353| 
        EOR       A1, A1, A3, LSR #8    ; [DPU_3_PIPE] |353| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |353| 
        LDRB      A1, [A2, +A1]         ; [DPU_3_PIPE] |353| 
        STRB      A1, [SP, #0]          ; [DPU_3_PIPE] |353| 
	.dwpsn	file "../driverlib/sw_crc.c",line 358,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |358| 
        ADDS      A1, A1, #2            ; [DPU_3_PIPE] |358| 
        STR       A1, [SP, #4]          ; [DPU_3_PIPE] |358| 
	.dwpsn	file "../driverlib/sw_crc.c",line 359,column 9,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |359| 
        SUBS      A1, A1, #2            ; [DPU_3_PIPE] |359| 
        STR       A1, [SP, #8]          ; [DPU_3_PIPE] |359| 
;* --------------------------------------------------------------------------*
||$C$L5||:    
	.dwpsn	file "../driverlib/sw_crc.c",line 366,column 5,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |366| 
        CBZ       A1, ||$C$L6||         ; [] 
        ; BRANCHCC OCCURS {||$C$L6||}    ; [] |366| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../driverlib/sw_crc.c",line 368,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |368| 
        LDRB      A3, [SP, #0]          ; [DPU_3_PIPE] |368| 
        LDR       A2, $C$CON1           ; [DPU_3_PIPE] |368| 
        LDRB      A1, [A1, #0]          ; [DPU_3_PIPE] |368| 
        EORS      A1, A1, A3            ; [DPU_3_PIPE] |368| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |368| 
        LDRB      A1, [A2, +A1]         ; [DPU_3_PIPE] |368| 
        STRB      A1, [SP, #0]          ; [DPU_3_PIPE] |368| 
;* --------------------------------------------------------------------------*
||$C$L6||:    
	.dwpsn	file "../driverlib/sw_crc.c",line 374,column 5,is_stmt,isa 1
        LDRB      A1, [SP, #0]          ; [DPU_3_PIPE] |374| 
...
$C$DW$13	.dwtag  DW_TAG_subprogram, DW_AT_name("Crc16")
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
        SUB       SP, SP, #16           ; [DPU_3_PIPE] 
	.dwcfi	cfa_offset, 16
$C$DW$17	.dwtag  DW_TAG_variable, DW_AT_name("ui16Crc")
	.dwattr $C$DW$17, DW_AT_TI_symbol_name("ui16Crc")
	.dwattr $C$DW$17, DW_AT_type(*$C$DW$T$22)
	.dwattr $C$DW$17, DW_AT_location[DW_OP_breg13 0]
$C$DW$18	.dwtag  DW_TAG_variable, DW_AT_name("pui8Data")
	.dwattr $C$DW$18, DW_AT_TI_symbol_name("pui8Data")
	.dwattr $C$DW$18, DW_AT_type(*$C$DW$T$29)
	.dwattr $C$DW$18, DW_AT_location[DW_OP_breg13 4]
$C$DW$19	.dwtag  DW_TAG_variable, DW_AT_name("ui32Count")
	.dwattr $C$DW$19, DW_AT_TI_symbol_name("ui32Count")
	.dwattr $C$DW$19, DW_AT_type(*$C$DW$T$19)
	.dwattr $C$DW$19, DW_AT_location[DW_OP_breg13 8]
$C$DW$20	.dwtag  DW_TAG_variable, DW_AT_name("ui32Temp")
	.dwattr $C$DW$20, DW_AT_TI_symbol_name("ui32Temp")
	.dwattr $C$DW$20, DW_AT_type(*$C$DW$T$19)
	.dwattr $C$DW$20, DW_AT_location[DW_OP_breg13 12]
        STR       A3, [SP, #8]          ; [DPU_3_PIPE] |412| 
        STR       A2, [SP, #4]          ; [DPU_3_PIPE] |412| 
        STRH      A1, [SP, #0]          ; [DPU_3_PIPE] |412| 
	.dwpsn	file "../driverlib/sw_crc.c",line 419,column 5,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |419| 
        LSRS      A1, A1, #1            ; [DPU_3_PIPE] |419| 
        BCC       ||$C$L7||             ; [DPU_3_PIPE] |419| 
        ; BRANCHCC OCCURS {||$C$L7||}    ; [] |419| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../driverlib/sw_crc.c",line 424,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |424| 
        LDRH      A2, [SP, #0]          ; [DPU_3_PIPE] |424| 
        LDR       A3, $C$CON2           ; [DPU_3_PIPE] |424| 
        LDRB      A1, [A1, #0]          ; [DPU_3_PIPE] |424| 
        EORS      A1, A1, A2            ; [DPU_3_PIPE] |424| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |424| 
        LDRH      A2, [SP, #0]          ; [DPU_3_PIPE] |424| 
        LDRH      A1, [A3, +A1, LSL #1] ; [DPU_3_PIPE] |424| 
        EOR       A1, A1, A2, ASR #8    ; [DPU_3_PIPE] |424| 
        STRH      A1, [SP, #0]          ; [DPU_3_PIPE] |424| 
	.dwpsn	file "../driverlib/sw_crc.c",line 429,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |429| 
        ADDS      A1, A1, #1            ; [DPU_3_PIPE] |429| 
        STR       A1, [SP, #4]          ; [DPU_3_PIPE] |429| 
	.dwpsn	file "../driverlib/sw_crc.c",line 430,column 9,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |430| 
        SUBS      A1, A1, #1            ; [DPU_3_PIPE] |430| 
        STR       A1, [SP, #8]          ; [DPU_3_PIPE] |430| 
;* --------------------------------------------------------------------------*
||$C$L7||:    
	.dwpsn	file "../driverlib/sw_crc.c",line 437,column 5,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |437| 
        LSRS      A1, A1, #2            ; [DPU_3_PIPE] |437| 
        BCC       ||$C$L8||             ; [DPU_3_PIPE] |437| 
        ; BRANCHCC OCCURS {||$C$L8||}    ; [] |437| 
;* --------------------------------------------------------------------------*
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |437| 
        CMP       A1, #1                ; [DPU_3_PIPE] |437| 
        BLS       ||$C$L8||             ; [DPU_3_PIPE] |437| 
        ; BRANCHCC OCCURS {||$C$L8||}    ; [] |437| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../driverlib/sw_crc.c",line 442,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |442| 
        LDRH      A1, [A1, #0]          ; [DPU_3_PIPE] |442| 
        STR       A1, [SP, #12]         ; [DPU_3_PIPE] |442| 
	.dwpsn	file "../driverlib/sw_crc.c",line 447,column 9,is_stmt,isa 1
        LDRH      A2, [SP, #0]          ; [DPU_3_PIPE] |447| 
        LDR       A3, $C$CON2           ; [DPU_3_PIPE] |447| 
        LDR       A1, [SP, #12]         ; [DPU_3_PIPE] |447| 
        EORS      A1, A1, A2            ; [DPU_3_PIPE] |447| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |447| 
        LDRH      A2, [SP, #0]          ; [DPU_3_PIPE] |447| 
        LDRH      A1, [A3, +A1, LSL #1] ; [DPU_3_PIPE] |447| 
        EOR       A1, A1, A2, ASR #8    ; [DPU_3_PIPE] |447| 
        STRH      A1, [SP, #0]          ; [DPU_3_PIPE] |447| 
	.dwpsn	file "../driverlib/sw_crc.c",line 448,column 9,is_stmt,isa 1
        LDRH      A1, [SP, #0]          ; [DPU_3_PIPE] |448| 
        LDR       A3, [SP, #12]         ; [DPU_3_PIPE] |448| 
        LDR       A2, $C$CON2           ; [DPU_3_PIPE] |448| 
        EOR       A1, A1, A3, LSR #8    ; [DPU_3_PIPE] |448| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |448| 
        LDRH      A3, [SP, #0]          ; [DPU_3_PIPE] |448| 
        LDRH      A1, [A2, +A1, LSL #1] ; [DPU_3_PIPE] |448| 
        EOR       A1, A1, A3, ASR #8    ; [DPU_3_PIPE] |448| 
        STRH      A1, [SP, #0]          ; [DPU_3_PIPE] |448| 
	.dwpsn	file "../driverlib/sw_crc.c",line 453,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |453| 
        ADDS      A1, A1, #2            ; [DPU_3_PIPE] |453| 
        STR       A1, [SP, #4]          ; [DPU_3_PIPE] |453| 
	.dwpsn	file "../driverlib/sw_crc.c",line 454,column 9,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |454| 
        SUBS      A1, A1, #2            ; [DPU_3_PIPE] |454| 
        STR       A1, [SP, #8]          ; [DPU_3_PIPE] |454| 
;* --------------------------------------------------------------------------*
||$C$L8||:    
	.dwpsn	file "../driverlib/sw_crc.c",line 461,column 11,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |461| 
        CMP       A1, #3                ; [DPU_3_PIPE] |461| 
        BLS       ||$C$L10||            ; [DPU_3_PIPE] |461| 
...
||$C$L9||:    
	.dwpsn	file "../driverlib/sw_crc.c",line 466,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |466| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |466| 
        STR       A1, [SP, #12]         ; [DPU_3_PIPE] |466| 
	.dwpsn	file "../driverlib/sw_crc.c",line 471,column 9,is_stmt,isa 1
        LDRH      A2, [SP, #0]          ; [DPU_3_PIPE] |471| 
        LDR       A3, $C$CON2           ; [DPU_3_PIPE] |471| 
        LDR       A1, [SP, #12]         ; [DPU_3_PIPE] |471| 
        EORS      A1, A1, A2            ; [DPU_3_PIPE] |471| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |471| 
        LDRH      A2, [SP, #0]          ; [DPU_3_PIPE] |471| 
        LDRH      A1, [A3, +A1, LSL #1] ; [DPU_3_PIPE] |471| 
        EOR       A1, A1, A2, ASR #8    ; [DPU_3_PIPE] |471| 
        STRH      A1, [SP, #0]          ; [DPU_3_PIPE] |471| 
	.dwpsn	file "../driverlib/sw_crc.c",line 472,column 9,is_stmt,isa 1
        LDRH      A1, [SP, #0]          ; [DPU_3_PIPE] |472| 
        LDR       A3, [SP, #12]         ; [DPU_3_PIPE] |472| 
        LDR       A2, $C$CON2           ; [DPU_3_PIPE] |472| 
        EOR       A1, A1, A3, LSR #8    ; [DPU_3_PIPE] |472| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |472| 
        LDRH      A3, [SP, #0]          ; [DPU_3_PIPE] |472| 
        LDRH      A1, [A2, +A1, LSL #1] ; [DPU_3_PIPE] |472| 
        EOR       A1, A1, A3, ASR #8    ; [DPU_3_PIPE] |472| 
        STRH      A1, [SP, #0]          ; [DPU_3_PIPE] |472| 
	.dwpsn	file "../driverlib/sw_crc.c",line 473,column 9,is_stmt,isa 1
        LDR       A3, [SP, #12]         ; [DPU_3_PIPE] |473| 
        LDRH      A1, [SP, #0]          ; [DPU_3_PIPE] |473| 
        LDR       A2, $C$CON2           ; [DPU_3_PIPE] |473| 
        EOR       A1, A1, A3, LSR #16   ; [DPU_3_PIPE] |473| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |473| 
        LDRH      A3, [SP, #0]          ; [DPU_3_PIPE] |473| 
        LDRH      A1, [A2, +A1, LSL #1] ; [DPU_3_PIPE] |473| 
        EOR       A1, A1, A3, ASR #8    ; [DPU_3_PIPE] |473| 
        STRH      A1, [SP, #0]          ; [DPU_3_PIPE] |473| 
	.dwpsn	file "../driverlib/sw_crc.c",line 474,column 9,is_stmt,isa 1
        LDR       A3, [SP, #12]         ; [DPU_3_PIPE] |474| 
        LDR       A2, $C$CON2           ; [DPU_3_PIPE] |474| 
        LDRH      A1, [SP, #0]          ; [DPU_3_PIPE] |474| 
        EOR       A1, A1, A3, LSR #24   ; [DPU_3_PIPE] |474| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |474| 
        LDRH      A3, [SP, #0]          ; [DPU_3_PIPE] |474| 
        LDRH      A1, [A2, +A1, LSL #1] ; [DPU_3_PIPE] |474| 
        EOR       A1, A1, A3, ASR #8    ; [DPU_3_PIPE] |474| 
        STRH      A1, [SP, #0]          ; [DPU_3_PIPE] |474| 
	.dwpsn	file "../driverlib/sw_crc.c",line 479,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |479| 
        ADDS      A1, A1, #4            ; [DPU_3_PIPE] |479| 
        STR       A1, [SP, #4]          ; [DPU_3_PIPE] |479| 
	.dwpsn	file "../driverlib/sw_crc.c",line 480,column 9,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |480| 
        SUBS      A1, A1, #4            ; [DPU_3_PIPE] |480| 
        STR       A1, [SP, #8]          ; [DPU_3_PIPE] |480| 
	.dwpsn	file "../driverlib/sw_crc.c",line 461,column 11,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |461| 
        CMP       A1, #3                ; [DPU_3_PIPE] |461| 
        BHI       ||$C$L9||             ; [DPU_3_PIPE] |461| 
        ; BRANCHCC OCCURS {||$C$L9||}    ; [] |461| 
;* --------------------------------------------------------------------------*
||$C$L10||:    
	.dwpsn	file "../driverlib/sw_crc.c",line 487,column 5,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |487| 
        CMP       A1, #1                ; [DPU_3_PIPE] |487| 
        BLS       ||$C$L11||            ; [DPU_3_PIPE] |487| 
        ; BRANCHCC OCCURS {||$C$L11||}   ; [] |487| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../driverlib/sw_crc.c",line 492,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |492| 
        LDRH      A1, [A1, #0]          ; [DPU_3_PIPE] |492| 
        STR       A1, [SP, #12]         ; [DPU_3_PIPE] |492| 
	.dwpsn	file "../driverlib/sw_crc.c",line 497,column 9,is_stmt,isa 1
        LDRH      A2, [SP, #0]          ; [DPU_3_PIPE] |497| 
        LDR       A3, $C$CON2           ; [DPU_3_PIPE] |497| 
        LDR       A1, [SP, #12]         ; [DPU_3_PIPE] |497| 
        EORS      A1, A1, A2            ; [DPU_3_PIPE] |497| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |497| 
        LDRH      A2, [SP, #0]          ; [DPU_3_PIPE] |497| 
        LDRH      A1, [A3, +A1, LSL #1] ; [DPU_3_PIPE] |497| 
        EOR       A1, A1, A2, ASR #8    ; [DPU_3_PIPE] |497| 
        STRH      A1, [SP, #0]          ; [DPU_3_PIPE] |497| 
	.dwpsn	file "../driverlib/sw_crc.c",line 498,column 9,is_stmt,isa 1
        LDRH      A1, [SP, #0]          ; [DPU_3_PIPE] |498| 
        LDR       A3, [SP, #12]         ; [DPU_3_PIPE] |498| 
        LDR       A2, $C$CON2           ; [DPU_3_PIPE] |498| 
        EOR       A1, A1, A3, LSR #8    ; [DPU_3_PIPE] |498| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |498| 
        LDRH      A3, [SP, #0]          ; [DPU_3_PIPE] |498| 
        LDRH      A1, [A2, +A1, LSL #1] ; [DPU_3_PIPE] |498| 
        EOR       A1, A1, A3, ASR #8    ; [DPU_3_PIPE] |498| 
        STRH      A1, [SP, #0]          ; [DPU_3_PIPE] |498| 
	.dwpsn	file "../driverlib/sw_crc.c",line 503,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |503| 
        ADDS      A1, A1, #2            ; [DPU_3_PIPE] |503| 
        STR       A1, [SP, #4]          ; [DPU_3_PIPE] |503| 
	.dwpsn	file "../driverlib/sw_crc.c",line 504,column 9,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |504| 
        SUBS      A1, A1, #2            ; [DPU_3_PIPE] |504| 
        STR       A1, [SP, #8]          ; [DPU_3_PIPE] |504| 
;* --------------------------------------------------------------------------*
||$C$L11||:    
...
;* --------------------------------------------------------------------------*
	.dwpsn	file "../driverlib/sw_crc.c",line 513,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |513| 
        LDRH      A2, [SP, #0]          ; [DPU_3_PIPE] |513| 
        LDR       A3, $C$CON2           ; [DPU_3_PIPE] |513| 
        LDRB      A1, [A1, #0]          ; [DPU_3_PIPE] |513| 
        EORS      A1, A1, A2            ; [DPU_3_PIPE] |513| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |513| 
        LDRH      A2, [SP, #0]          ; [DPU_3_PIPE] |513| 
        LDRH      A1, [A3, +A1, LSL #1] ; [DPU_3_PIPE] |513| 
        EOR       A1, A1, A2, ASR #8    ; [DPU_3_PIPE] |513| 
        STRH      A1, [SP, #0]          ; [DPU_3_PIPE] |513| 
;* --------------------------------------------------------------------------*
||$C$L12||:    
	.dwpsn	file "../driverlib/sw_crc.c",line 519,column 5,is_stmt,isa 1
        LDRH      A1, [SP, #0]          ; [DPU_3_PIPE] |519| 
...
$C$DW$22	.dwtag  DW_TAG_subprogram, DW_AT_name("Crc16Array")
...
$C$DW$23	.dwtag  DW_TAG_formal_parameter, DW_AT_name("ui32WordLen")
	.dwattr $C$DW$23, DW_AT_TI_symbol_name("ui32WordLen")
	.dwattr $C$DW$23, DW_AT_type(*$C$DW$T$19)
	.dwattr $C$DW$23, DW_AT_location[DW_OP_reg0]
$C$DW$24	.dwtag  DW_TAG_formal_parameter, DW_AT_name("pui32Data")
...
$C$DW$25	.dwtag  DW_TAG_variable, DW_AT_name("ui32WordLen")
	.dwattr $C$DW$25, DW_AT_TI_symbol_name("ui32WordLen")
	.dwattr $C$DW$25, DW_AT_type(*$C$DW$T$19)
	.dwattr $C$DW$25, DW_AT_location[DW_OP_breg13 0]
$C$DW$26	.dwtag  DW_TAG_variable, DW_AT_name("pui32Data")
...
$C$DW$29	.dwtag  DW_TAG_subprogram, DW_AT_name("Crc16Array3")
...
;* --------------------------------------------------------------------------*
	...
	.dwcfi	cfa_offset, 24
$C$DW$33	.dwtag  DW_TAG_variable, DW_AT_name("ui32WordLen")
	.dwattr $C$DW$33, DW_AT_TI_symbol_name("ui32WordLen")
	.dwattr $C$DW$33, DW_AT_type(*$C$DW$T$19)
	.dwattr $C$DW$33, DW_AT_location[DW_OP_breg13 0]
$C$DW$34	.dwtag  DW_TAG_variable, DW_AT_name("pui32Data")
...
$C$DW$35	.dwtag  DW_TAG_variable, DW_AT_name("pui16Crc3")
...
$C$DW$36	.dwtag  DW_TAG_variable, DW_AT_name("ui16Crc")
	.dwattr $C$DW$36, DW_AT_TI_symbol_name("ui16Crc")
	.dwattr $C$DW$36, DW_AT_type(*$C$DW$T$22)
	.dwattr $C$DW$36, DW_AT_location[DW_OP_breg13 12]
$C$DW$37	.dwtag  DW_TAG_variable, DW_AT_name("ui16Cri8Odd")
	.dwattr $C$DW$37, DW_AT_TI_symbol_name("ui16Cri8Odd")
	.dwattr $C$DW$37, DW_AT_type(*$C$DW$T$22)
	.dwattr $C$DW$37, DW_AT_location[DW_OP_breg13 14]
$C$DW$38	.dwtag  DW_TAG_variable, DW_AT_name("ui16Cri8Even")
	.dwattr $C$DW$38, DW_AT_TI_symbol_name("ui16Cri8Even")
	.dwattr $C$DW$38, DW_AT_type(*$C$DW$T$22)
	.dwattr $C$DW$38, DW_AT_location[DW_OP_breg13 16]
$C$DW$39	.dwtag  DW_TAG_variable, DW_AT_name("ui32Temp")
	.dwattr $C$DW$39, DW_AT_TI_symbol_name("ui32Temp")
	.dwattr $C$DW$39, DW_AT_type(*$C$DW$T$19)
	.dwattr $C$DW$39, DW_AT_location[DW_OP_breg13 20]
        STR       A3, [SP, #8]          ; [DPU_3_PIPE] |567| 
        STR       A2, [SP, #4]          ; [DPU_3_PIPE] |567| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |567| 
	.dwpsn	file "../driverlib/sw_crc.c",line 574,column 5,is_stmt,isa 1
        MOVS      A1, #0                ; [DPU_3_PIPE] |574| 
        STRH      A1, [SP, #12]         ; [DPU_3_PIPE] |574| 
	.dwpsn	file "../driverlib/sw_crc.c",line 575,column 5,is_stmt,isa 1
        MOVS      A1, #0                ; [DPU_3_PIPE] |575| 
        STRH      A1, [SP, #14]         ; [DPU_3_PIPE] |575| 
	.dwpsn	file "../driverlib/sw_crc.c",line 576,column 5,is_stmt,isa 1
        MOVS      A1, #0                ; [DPU_3_PIPE] |576| 
        STRH      A1, [SP, #16]         ; [DPU_3_PIPE] |576| 
	.dwpsn	file "../driverlib/sw_crc.c",line 581,column 5,is_stmt,isa 1
        LDR       A1, [SP, #0]          ; [DPU_3_PIPE] |581| 
        SUBS      A2, A1, #1            ; [DPU_3_PIPE] |581| 
        CMP       A1, #0                ; [DPU_3_PIPE] |581| 
        STR       A2, [SP, #0]          ; [DPU_3_PIPE] |581| 
        BEQ       ||$C$L14||            ; [DPU_3_PIPE] |581| 
...
||$C$L13||:    
	.dwpsn	file "../driverlib/sw_crc.c",line 586,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |586| 
        LDR       A2, [A1], #4          ; [DPU_3_PIPE] |586| 
        STR       A1, [SP, #4]          ; [DPU_3_PIPE] |586| 
        STR       A2, [SP, #20]         ; [DPU_3_PIPE] |586| 
	.dwpsn	file "../driverlib/sw_crc.c",line 591,column 9,is_stmt,isa 1
        LDRH      A2, [SP, #12]         ; [DPU_3_PIPE] |591| 
        LDR       A3, $C$CON2           ; [DPU_3_PIPE] |591| 
        LDR       A1, [SP, #20]         ; [DPU_3_PIPE] |591| 
        EORS      A1, A1, A2            ; [DPU_3_PIPE] |591| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |591| 
        LDRH      A2, [SP, #12]         ; [DPU_3_PIPE] |591| 
        LDRH      A1, [A3, +A1, LSL #1] ; [DPU_3_PIPE] |591| 
        EOR       A1, A1, A2, ASR #8    ; [DPU_3_PIPE] |591| 
        STRH      A1, [SP, #12]         ; [DPU_3_PIPE] |591| 
	.dwpsn	file "../driverlib/sw_crc.c",line 592,column 9,is_stmt,isa 1
        LDRH      A1, [SP, #12]         ; [DPU_3_PIPE] |592| 
        LDR       A3, [SP, #20]         ; [DPU_3_PIPE] |592| 
        LDR       A2, $C$CON2           ; [DPU_3_PIPE] |592| 
        EOR       A1, A1, A3, LSR #8    ; [DPU_3_PIPE] |592| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |592| 
        LDRH      A3, [SP, #12]         ; [DPU_3_PIPE] |592| 
        LDRH      A1, [A2, +A1, LSL #1] ; [DPU_3_PIPE] |592| 
        EOR       A1, A1, A3, ASR #8    ; [DPU_3_PIPE] |592| 
        STRH      A1, [SP, #12]         ; [DPU_3_PIPE] |592| 
	.dwpsn	file "../driverlib/sw_crc.c",line 593,column 9,is_stmt,isa 1
        LDR       A3, [SP, #20]         ; [DPU_3_PIPE] |593| 
        LDRH      A1, [SP, #12]         ; [DPU_3_PIPE] |593| 
        LDR       A2, $C$CON2           ; [DPU_3_PIPE] |593| 
        EOR       A1, A1, A3, LSR #16   ; [DPU_3_PIPE] |593| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |593| 
        LDRH      A3, [SP, #12]         ; [DPU_3_PIPE] |593| 
        LDRH      A1, [A2, +A1, LSL #1] ; [DPU_3_PIPE] |593| 
        EOR       A1, A1, A3, ASR #8    ; [DPU_3_PIPE] |593| 
        STRH      A1, [SP, #12]         ; [DPU_3_PIPE] |593| 
	.dwpsn	file "../driverlib/sw_crc.c",line 594,column 9,is_stmt,isa 1
        LDR       A3, [SP, #20]         ; [DPU_3_PIPE] |594| 
        LDR       A2, $C$CON2           ; [DPU_3_PIPE] |594| 
        LDRH      A1, [SP, #12]         ; [DPU_3_PIPE] |594| 
        EOR       A1, A1, A3, LSR #24   ; [DPU_3_PIPE] |594| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |594| 
        LDRH      A3, [SP, #12]         ; [DPU_3_PIPE] |594| 
        LDRH      A1, [A2, +A1, LSL #1] ; [DPU_3_PIPE] |594| 
        EOR       A1, A1, A3, ASR #8    ; [DPU_3_PIPE] |594| 
        STRH      A1, [SP, #12]         ; [DPU_3_PIPE] |594| 
	.dwpsn	file "../driverlib/sw_crc.c",line 599,column 9,is_stmt,isa 1
        LDRH      A2, [SP, #16]         ; [DPU_3_PIPE] |599| 
        LDR       A1, [SP, #20]         ; [DPU_3_PIPE] |599| 
        LDR       A3, $C$CON2           ; [DPU_3_PIPE] |599| 
        EORS      A1, A1, A2            ; [DPU_3_PIPE] |599| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |599| 
        LDRH      A2, [SP, #16]         ; [DPU_3_PIPE] |599| 
        LDRH      A1, [A3, +A1, LSL #1] ; [DPU_3_PIPE] |599| 
        EOR       A1, A1, A2, ASR #8    ; [DPU_3_PIPE] |599| 
        STRH      A1, [SP, #16]         ; [DPU_3_PIPE] |599| 
	.dwpsn	file "../driverlib/sw_crc.c",line 600,column 9,is_stmt,isa 1
        LDRH      A1, [SP, #16]         ; [DPU_3_PIPE] |600| 
        LDR       A3, [SP, #20]         ; [DPU_3_PIPE] |600| 
        LDR       A2, $C$CON2           ; [DPU_3_PIPE] |600| 
        EOR       A1, A1, A3, LSR #16   ; [DPU_3_PIPE] |600| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |600| 
        LDRH      A3, [SP, #16]         ; [DPU_3_PIPE] |600| 
        LDRH      A1, [A2, +A1, LSL #1] ; [DPU_3_PIPE] |600| 
        EOR       A1, A1, A3, ASR #8    ; [DPU_3_PIPE] |600| 
        STRH      A1, [SP, #16]         ; [DPU_3_PIPE] |600| 
	.dwpsn	file "../driverlib/sw_crc.c",line 605,column 9,is_stmt,isa 1
        LDRH      A1, [SP, #14]         ; [DPU_3_PIPE] |605| 
        LDR       A3, [SP, #20]         ; [DPU_3_PIPE] |605| 
        LDR       A2, $C$CON2           ; [DPU_3_PIPE] |605| 
        EOR       A1, A1, A3, LSR #8    ; [DPU_3_PIPE] |605| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |605| 
        LDRH      A3, [SP, #14]         ; [DPU_3_PIPE] |605| 
        LDRH      A1, [A2, +A1, LSL #1] ; [DPU_3_PIPE] |605| 
        EOR       A1, A1, A3, ASR #8    ; [DPU_3_PIPE] |605| 
        STRH      A1, [SP, #14]         ; [DPU_3_PIPE] |605| 
	.dwpsn	file "../driverlib/sw_crc.c",line 606,column 9,is_stmt,isa 1
        LDRH      A1, [SP, #14]         ; [DPU_3_PIPE] |606| 
        LDR       A3, [SP, #20]         ; [DPU_3_PIPE] |606| 
        LDR       A2, $C$CON2           ; [DPU_3_PIPE] |606| 
        EOR       A1, A1, A3, LSR #24   ; [DPU_3_PIPE] |606| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |606| 
        LDRH      A3, [SP, #14]         ; [DPU_3_PIPE] |606| 
        LDRH      A1, [A2, +A1, LSL #1] ; [DPU_3_PIPE] |606| 
        EOR       A1, A1, A3, ASR #8    ; [DPU_3_PIPE] |606| 
        STRH      A1, [SP, #14]         ; [DPU_3_PIPE] |606| 
	.dwpsn	file "../driverlib/sw_crc.c",line 581,column 5,is_stmt,isa 1
        LDR       A1, [SP, #0]          ; [DPU_3_PIPE] |581| 
        CMP       A1, #0                ; [DPU_3_PIPE] |581| 
        SUB       A2, A1, #1            ; [DPU_3_PIPE] |581| 
        STR       A2, [SP, #0]          ; [DPU_3_PIPE] |581| 
        BNE       ||$C$L13||            ; [DPU_3_PIPE] |581| 
        ; BRANCHCC OCCURS {||$C$L13||}   ; [] |581| 
;* --------------------------------------------------------------------------*
||$C$L14||:    
	.dwpsn	file "../driverlib/sw_crc.c",line 612,column 5,is_stmt,isa 1
        LDRH      A1, [SP, #12]         ; [DPU_3_PIPE] |612| 
        LDR       A2, [SP, #8]          ; [DPU_3_PIPE] |612| 
        STRH      A1, [A2, #0]          ; [DPU_3_PIPE] |612| 
	.dwpsn	file "../driverlib/sw_crc.c",line 613,column 5,is_stmt,isa 1
        LDRH      A1, [SP, #16]         ; [DPU_3_PIPE] |613| 
        LDR       A2, [SP, #8]          ; [DPU_3_PIPE] |613| 
        STRH      A1, [A2, #2]          ; [DPU_3_PIPE] |613| 
	.dwpsn	file "../driverlib/sw_crc.c",line 614,column 5,is_stmt,isa 1
        LDRH      A1, [SP, #14]         ; [DPU_3_PIPE] |614| 
        LDR       A2, [SP, #8]          ; [DPU_3_PIPE] |614| 
        STRH      A1, [A2, #4]          ; [DPU_3_PIPE] |614| 
...
$C$DW$41	.dwtag  DW_TAG_subprogram, DW_AT_name("Crc32")
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
        SUB       SP, SP, #16           ; [DPU_3_PIPE] 
	.dwcfi	cfa_offset, 16
$C$DW$45	.dwtag  DW_TAG_variable, DW_AT_name("ui32Crc")
	.dwattr $C$DW$45, DW_AT_TI_symbol_name("ui32Crc")
	.dwattr $C$DW$45, DW_AT_type(*$C$DW$T$19)
	.dwattr $C$DW$45, DW_AT_location[DW_OP_breg13 0]
$C$DW$46	.dwtag  DW_TAG_variable, DW_AT_name("pui8Data")
...
;* --------------------------------------------------------------------------*
	.dwpsn	file "../driverlib/sw_crc.c",line 667,column 9,is_stmt,isa 1
        ...
        LDR       A3, $C$CON3           ; [DPU_3_PIPE] |667| 
        LDRB      A2, [A2, #0]          ; [DPU_3_PIPE] |667| 
        AND       A1, A1, #255          ; [DPU_3_PIPE] |667| 
        EORS      A2, A2, A1            ; [DPU_3_PIPE] |667| 
        UXTB      A1, A2                ; [DPU_3_PIPE] |667| 
        LDR       A2, [SP, #0]          ; [DPU_3_PIPE] |667| 
        LDR       A1, [A3, +A1, LSL #2] ; [DPU_3_PIPE] |667| 
        EOR       A1, A1, A2, LSR #8    ; [DPU_3_PIPE] |667| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |667| 
	.dwpsn	file "../driverlib/sw_crc.c",line 672,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |672| 
        ADDS      A1, A1, #1            ; [DPU_3_PIPE] |672| 
        STR       A1, [SP, #4]          ; [DPU_3_PIPE] |672| 
	.dwpsn	file "../driverlib/sw_crc.c",line 673,column 9,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |673| 
        SUBS      A1, A1, #1            ; [DPU_3_PIPE] |673| 
        STR       A1, [SP, #8]          ; [DPU_3_PIPE] |673| 
;* --------------------------------------------------------------------------*
||$C$L15||:    
	.dwpsn	file "../driverlib/sw_crc.c",line 680,column 5,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |680| 
        LSRS      A1, A1, #2            ; [DPU_3_PIPE] |680| 
        BCC       ||$C$L16||            ; [DPU_3_PIPE] |680| 
        ; BRANCHCC OCCURS {||$C$L16||}   ; [] |680| 
;* --------------------------------------------------------------------------*
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |680| 
        CMP       A1, #1                ; [DPU_3_PIPE] |680| 
        BLS       ||$C$L16||            ; [DPU_3_PIPE] |680| 
        ; BRANCHCC OCCURS {||$C$L16||}   ; [] |680| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../driverlib/sw_crc.c",line 685,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |685| 
        LDRH      A1, [A1, #0]          ; [DPU_3_PIPE] |685| 
        STR       A1, [SP, #12]         ; [DPU_3_PIPE] |685| 
	.dwpsn	file "../driverlib/sw_crc.c",line 690,column 9,is_stmt,isa 1
        LDR       A1, [SP, #0]          ; [DPU_3_PIPE] |690| 
        LDR       A2, [SP, #12]         ; [DPU_3_PIPE] |690| 
        LDR       A3, $C$CON3           ; [DPU_3_PIPE] |690| 
        AND       A1, A1, #255          ; [DPU_3_PIPE] |690| 
        EORS      A2, A2, A1            ; [DPU_3_PIPE] |690| 
        UXTB      A1, A2                ; [DPU_3_PIPE] |690| 
        LDR       A2, [SP, #0]          ; [DPU_3_PIPE] |690| 
        LDR       A1, [A3, +A1, LSL #2] ; [DPU_3_PIPE] |690| 
        EOR       A1, A1, A2, LSR #8    ; [DPU_3_PIPE] |690| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |690| 
	.dwpsn	file "../driverlib/sw_crc.c",line 691,column 9,is_stmt,isa 1
        LDR       A1, [SP, #0]          ; [DPU_3_PIPE] |691| 
        LDR       A3, [SP, #12]         ; [DPU_3_PIPE] |691| 
        LDR       A2, $C$CON3           ; [DPU_3_PIPE] |691| 
        AND       A1, A1, #255          ; [DPU_3_PIPE] |691| 
        EOR       A1, A1, A3, LSR #8    ; [DPU_3_PIPE] |691| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |691| 
        LDR       A3, [SP, #0]          ; [DPU_3_PIPE] |691| 
        LDR       A1, [A2, +A1, LSL #2] ; [DPU_3_PIPE] |691| 
        EOR       A1, A1, A3, LSR #8    ; [DPU_3_PIPE] |691| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |691| 
	.dwpsn	file "../driverlib/sw_crc.c",line 696,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |696| 
        ADDS      A1, A1, #2            ; [DPU_3_PIPE] |696| 
        STR       A1, [SP, #4]          ; [DPU_3_PIPE] |696| 
	.dwpsn	file "../driverlib/sw_crc.c",line 697,column 9,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |697| 
        SUBS      A1, A1, #2            ; [DPU_3_PIPE] |697| 
        STR       A1, [SP, #8]          ; [DPU_3_PIPE] |697| 
;* --------------------------------------------------------------------------*
||$C$L16||:    
	.dwpsn	file "../driverlib/sw_crc.c",line 704,column 11,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |704| 
        CMP       A1, #3                ; [DPU_3_PIPE] |704| 
        BLS       ||$C$L18||            ; [DPU_3_PIPE] |704| 
...
||$C$L17||:    
	.dwpsn	file "../driverlib/sw_crc.c",line 709,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |709| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |709| 
        STR       A1, [SP, #12]         ; [DPU_3_PIPE] |709| 
	.dwpsn	file "../driverlib/sw_crc.c",line 714,column 9,is_stmt,isa 1
        LDR       A1, [SP, #0]          ; [DPU_3_PIPE] |714| 
        LDR       A2, [SP, #12]         ; [DPU_3_PIPE] |714| 
        LDR       A3, $C$CON3           ; [DPU_3_PIPE] |714| 
        AND       A1, A1, #255          ; [DPU_3_PIPE] |714| 
        EORS      A2, A2, A1            ; [DPU_3_PIPE] |714| 
        UXTB      A1, A2                ; [DPU_3_PIPE] |714| 
        LDR       A2, [SP, #0]          ; [DPU_3_PIPE] |714| 
        LDR       A1, [A3, +A1, LSL #2] ; [DPU_3_PIPE] |714| 
        EOR       A1, A1, A2, LSR #8    ; [DPU_3_PIPE] |714| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |714| 
	.dwpsn	file "../driverlib/sw_crc.c",line 715,column 9,is_stmt,isa 1
        LDR       A1, [SP, #0]          ; [DPU_3_PIPE] |715| 
        LDR       A3, [SP, #12]         ; [DPU_3_PIPE] |715| 
        LDR       A2, $C$CON3           ; [DPU_3_PIPE] |715| 
        AND       A1, A1, #255          ; [DPU_3_PIPE] |715| 
        EOR       A1, A1, A3, LSR #8    ; [DPU_3_PIPE] |715| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |715| 
        LDR       A3, [SP, #0]          ; [DPU_3_PIPE] |715| 
        LDR       A1, [A2, +A1, LSL #2] ; [DPU_3_PIPE] |715| 
        EOR       A1, A1, A3, LSR #8    ; [DPU_3_PIPE] |715| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |715| 
	.dwpsn	file "../driverlib/sw_crc.c",line 716,column 9,is_stmt,isa 1
        LDR       A1, [SP, #0]          ; [DPU_3_PIPE] |716| 
        LDR       A3, [SP, #12]         ; [DPU_3_PIPE] |716| 
        LDR       A2, $C$CON3           ; [DPU_3_PIPE] |716| 
        AND       A1, A1, #255          ; [DPU_3_PIPE] |716| 
        EOR       A1, A1, A3, LSR #16   ; [DPU_3_PIPE] |716| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |716| 
        LDR       A3, [SP, #0]          ; [DPU_3_PIPE] |716| 
        LDR       A1, [A2, +A1, LSL #2] ; [DPU_3_PIPE] |716| 
        EOR       A1, A1, A3, LSR #8    ; [DPU_3_PIPE] |716| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |716| 
	.dwpsn	file "../driverlib/sw_crc.c",line 717,column 9,is_stmt,isa 1
        LDR       A3, [SP, #12]         ; [DPU_3_PIPE] |717| 
        LDR       A2, $C$CON3           ; [DPU_3_PIPE] |717| 
        LDR       A1, [SP, #0]          ; [DPU_3_PIPE] |717| 
        AND       A1, A1, #255          ; [DPU_3_PIPE] |717| 
        EOR       A1, A1, A3, LSR #24   ; [DPU_3_PIPE] |717| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |717| 
        LDR       A3, [SP, #0]          ; [DPU_3_PIPE] |717| 
        LDR       A1, [A2, +A1, LSL #2] ; [DPU_3_PIPE] |717| 
        EOR       A1, A1, A3, LSR #8    ; [DPU_3_PIPE] |717| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |717| 
	.dwpsn	file "../driverlib/sw_crc.c",line 722,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |722| 
        ADDS      A1, A1, #4            ; [DPU_3_PIPE] |722| 
        STR       A1, [SP, #4]          ; [DPU_3_PIPE] |722| 
	.dwpsn	file "../driverlib/sw_crc.c",line 723,column 9,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |723| 
        SUBS      A1, A1, #4            ; [DPU_3_PIPE] |723| 
        STR       A1, [SP, #8]          ; [DPU_3_PIPE] |723| 
	.dwpsn	file "../driverlib/sw_crc.c",line 704,column 11,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |704| 
        CMP       A1, #3                ; [DPU_3_PIPE] |704| 
        BHI       ||$C$L17||            ; [DPU_3_PIPE] |704| 
        ; BRANCHCC OCCURS {||$C$L17||}   ; [] |704| 
;* --------------------------------------------------------------------------*
||$C$L18||:    
	.dwpsn	file "../driverlib/sw_crc.c",line 730,column 5,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |730| 
        CMP       A1, #1                ; [DPU_3_PIPE] |730| 
        BLS       ||$C$L19||            ; [DPU_3_PIPE] |730| 
        ; BRANCHCC OCCURS {||$C$L19||}   ; [] |730| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../driverlib/sw_crc.c",line 735,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |735| 
        LDRH      A1, [A1, #0]          ; [DPU_3_PIPE] |735| 
        STR       A1, [SP, #12]         ; [DPU_3_PIPE] |735| 
	.dwpsn	file "../driverlib/sw_crc.c",line 740,column 9,is_stmt,isa 1
        LDR       A1, [SP, #0]          ; [DPU_3_PIPE] |740| 
        LDR       A2, [SP, #12]         ; [DPU_3_PIPE] |740| 
        LDR       A3, $C$CON3           ; [DPU_3_PIPE] |740| 
        AND       A1, A1, #255          ; [DPU_3_PIPE] |740| 
        EORS      A2, A2, A1            ; [DPU_3_PIPE] |740| 
        UXTB      A1, A2                ; [DPU_3_PIPE] |740| 
        LDR       A2, [SP, #0]          ; [DPU_3_PIPE] |740| 
        LDR       A1, [A3, +A1, LSL #2] ; [DPU_3_PIPE] |740| 
        EOR       A1, A1, A2, LSR #8    ; [DPU_3_PIPE] |740| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |740| 
	.dwpsn	file "../driverlib/sw_crc.c",line 741,column 9,is_stmt,isa 1
        LDR       A1, [SP, #0]          ; [DPU_3_PIPE] |741| 
        LDR       A3, [SP, #12]         ; [DPU_3_PIPE] |741| 
        LDR       A2, $C$CON3           ; [DPU_3_PIPE] |741| 
        AND       A1, A1, #255          ; [DPU_3_PIPE] |741| 
        EOR       A1, A1, A3, LSR #8    ; [DPU_3_PIPE] |741| 
        UXTB      A1, A1                ; [DPU_3_PIPE] |741| 
        LDR       A3, [SP, #0]          ; [DPU_3_PIPE] |741| 
        LDR       A1, [A2, +A1, LSL #2] ; [DPU_3_PIPE] |741| 
        EOR       A1, A1, A3, LSR #8    ; [DPU_3_PIPE] |741| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |741| 
	.dwpsn	file "../driverlib/sw_crc.c",line 746,column 9,is_stmt,isa 1
        LDR       A1, [SP, #4]          ; [DPU_3_PIPE] |746| 
        ADDS      A1, A1, #2            ; [DPU_3_PIPE] |746| 
        STR       A1, [SP, #4]          ; [DPU_3_PIPE] |746| 
	.dwpsn	file "../driverlib/sw_crc.c",line 747,column 9,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |747| 
        SUBS      A1, A1, #2            ; [DPU_3_PIPE] |747| 
        STR       A1, [SP, #8]          ; [DPU_3_PIPE] |747| 
;* --------------------------------------------------------------------------*
||$C$L19||:    
	.dwpsn	file "../driverlib/sw_crc.c",line 754,column 5,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_3_PIPE] |754| 
        CBZ       A1, ||$C$L20||        ; [] 
        ; BRANCHCC OCCURS {||$C$L20||}   ; [] |754| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../driverlib/sw_crc.c",line 756,column 9,is_stmt,isa 1
        LDR       A2, [SP, #4]          ; [DPU_3_PIPE] |756| 
        LDR       A1, [SP, #0]          ; [DPU_3_PIPE] |756| 
        LDR       A3, $C$CON3           ; [DPU_3_PIPE] |756| 
        LDRB      A2, [A2, #0]          ; [DPU_3_PIPE] |756| 
        AND       A1, A1, #255          ; [DPU_3_PIPE] |756| 
        EORS      A2, A2, A1            ; [DPU_3_PIPE] |756| 
        UXTB      A1, A2                ; [DPU_3_PIPE] |756| 
        LDR       A2, [SP, #0]          ; [DPU_3_PIPE] |756| 
        LDR       A1, [A3, +A1, LSL #2] ; [DPU_3_PIPE] |756| 
        EOR       A1, A1, A2, LSR #8    ; [DPU_3_PIPE] |756| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |756| 
;* --------------------------------------------------------------------------*
||$C$L20||:    
...
$C$DW$50	.dwtag  DW_TAG_subrange_type
	.dwattr $C$DW$50, DW_AT_upper_bound(0xff)
	.dwendtag $C$DW$T$31
...
$C$DW$T$39	.dwtag  DW_TAG_array_type
	...
	.dwattr $C$DW$T$39, DW_AT_byte_size(0x200)
...
$C$DW$T$50	.dwtag  DW_TAG_array_type
	...
	.dwattr $C$DW$T$50, DW_AT_byte_size(0x400)
...
$C$DW$T$66	.dwtag  DW_TAG_typedef, DW_AT_name("__builtin_va_list")
	.dwattr $C$DW$T$66, DW_AT_type(*$C$DW$T$65)
	.dwattr $C$DW$T$66, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$66, DW_AT_decl_file("../driverlib/sw_crc.c")
	.dwattr $C$DW$T$66, DW_AT_decl_line(0x2fb)
